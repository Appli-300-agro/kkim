      ...
      <section className="bg-primary py-20 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-primary-light max-w-xl mx-auto">
            Une demande de réservation ? Un événement à organiser ? Notre équipe réagit sous 24h pour vous régaler.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary font-medium">+237 600 00 00 00</p>
                <div className="mt-3">
                  <a 
                    href="https://wa.me/237600000000" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg text-xs font-bold hover:bg-green-600 transition-colors shadow-lg"
                  >
                    <MessageCircle className="w-4 h-4" />
                    Discuter sur WhatsApp
                  </a>
                </div>
                <p className="text-[10px] text-primary font-medium mt-2 uppercase tracking-tighter">Lundi - Samedi : 8h00 - 18h00</p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">contact@kkim.cm</p>
                <p className="text-sm text-secondary">support@kkim.cm</p>
              </div>
            </div>
