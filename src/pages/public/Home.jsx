  ...
  const slides = [
    {
      ...
      subtitle: "Gastronomie, Saveurs Authentiques et Service d'Excellence. La référence premium pour les gourmets au Cameroun.",
      cta1: { label: "Notre Carte", link: "/catalogue", icon: true },
      cta2: { label: "Expertise", link: "/contact" },
      icon: "🥘",
      iconLabel: "Cuisine Locale"
    },
    {
      title: <>Votre Partenaire <br /> <span className="text-primary-light italic">Culinaire</span></>,
      subtitle: "KKIM accompagne vos moments de partage avec des solutions traiteur innovantes et savoureuses.",
      cta1: { label: "À Propos", link: "/a-propos", icon: false },
      cta2: { label: "Notre Carte", link: "#secteurs", action: scrollToSectors },
      icon: "👩‍🍳",
      iconLabel: "Chef Passionné"
    },
    {
      title: <>Une Équipe <br /> <span className="text-primary-light italic">Passionnée</span></>,
      subtitle: "Besoin d'une réservation ou d'une prestation traiteur ? Notre équipe vous répond sous 24h.",
      cta1: { label: "Contact", link: "/contact", icon: true },
      cta2: { label: "WhatsApp", link: "https://wa.me/237600000000" },
      icon: "🍷",
      iconLabel: "Service Premium"
    }
  ];
      ...
      <section className="relative min-h-[95vh] flex items-center overflow-hidden text-white bg-secondary-dark">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img 
            ...
            alt="Gastronomy Background" 
            className="w-full h-full object-cover animate-pulse-slow"
          />
          {/* Simulation of animated background: could be a video tag if local asset exists */}
        </div>

        <ParticlesBackground />
        
        <div className="container mx-auto px-4 relative z-20 py-12 md:py-20">
