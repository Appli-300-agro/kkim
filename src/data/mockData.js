// Catalogue de 100 produits pour KKIM
...
const generateProducts = () => {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    products.push({
      id: `prod-${i}`,
      name: productName,
      description: `Découvrez notre ${dishBaseName}, une solution de la catégorie ${sector} proposée par KKIM. Qualité garantie.`,
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@kkim.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' },
...
export const MOCK_ORDERS = [
  {
    ...
    items: [{ name: 'Ndolé Crevettes & Viande', quantity: 2, price: 7500 }]
  },
  {
    id: 'ORD-2026-002',
    ...
    total: 8500,
    status: 'Livré',
    items: [{ name: 'Poulet DG Royal', quantity: 1, price: 8500 }]
  }
];
